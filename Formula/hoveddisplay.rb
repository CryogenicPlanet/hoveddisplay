class Hovedisplay < Formula
  desc "macOS command-line utility to configure main display"
  homepage "https://github.com/CryogenicPlanet/hovedisplay"
  url "https://github.com/CryogenicPlanet/hovedisplay/archive/refs/tags/v0.0.1.tar.gz"
